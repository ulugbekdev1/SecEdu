...
const ACHIEVEMENTS = [
  { Icon: IcoTarget, label: "Birinchi material", check: (w) => w >= 1 },
  { Icon: IcoFlame,  label: "5 ta material",     check: (w) => w >= 5 },
  { Icon: IcoStar,   label: "50% progress",      check: (_, p) => p >= 50 },
  { Icon: IcoAward,  label: "100% progress",     check: (_, p) => p >= 100 },
];
      ...
      <div className="profile-grid" style={S.grid}>
        ...
        <div style={S.profileCard}>
          ...
          <div style={S.infoList}>
            ...
            <InfoRow label="Platforma" value="SecureEdu" />
          </div>
          ...
          <div style={S.card}>
            ...
            <div style={S.progressStats}>
              <div style={S.pStat}>
                ...
                <div style={S.pStatLabel}>Ko'rilgan</div>
              </div>
              ...
              {ACHIEVEMENTS.map((a) => {
                ...
                return (
                  <div key={a.label} style={{ ...S.achieve, ...(done ? S.achieveDone : S.achieveLocked) }}>
                    <div style={{
                      ...S.achieveIconBox,
                      background: done ? "var(--accent-light)" : "var(--border)",
...
const S = {
  ...
  avatar: {
    ...
    boxShadow: "0 6px 20px rgba(170,59,255,0.35)",
  },
  avatarBadge: {
